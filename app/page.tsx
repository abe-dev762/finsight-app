      ...
      <div className='max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6'>
          ...
          <div className='space-y-4 sm:space-y-6'>
            <div className='bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6'>
