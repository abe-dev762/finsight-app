  ...
  if (error) {
    return (
      <div className='bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-700/50 hover:shadow-2xl'>
        ...
        <div className='bg-red-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-red-500'>
          ...
          <p className='text-red-400 text-xs ml-8'>{error}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className='bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-700/50 hover:shadow-2xl'>
        ...
        <div className='text-center py-6 sm:py-8'>
          <div className='w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-gray-700 to-gray-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg'>
            <span className='text-2xl sm:text-3xl'>📈</span>
          </div>
          <h4 className='text-base sm:text-lg font-bold text-gray-200 mb-2'>
            No Data to Display
          </h4>
    ...
    <div className='bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-700/50 hover:shadow-2xl'>
      <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
        ...
        <div>
          ...
          <p className='text-xs text-gray-400 mt-0.5'>            Visual representation of your spending
          </p>
        </div>
      </div>
