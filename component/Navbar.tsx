      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='flex items-center'>
            ...
            >
              <div className='w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-r from-fuchsia-400 via-pink-400 to-rose-400 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3'>
                <span className='text-white text-xs sm:text-sm md:text-lg font-bold'>
                  💵
                </span>
              </div>
              <span className='text-sm sm:text-base md:text-lg lg:text-xl font-bold bg-gradient-to-r from-fuchsia-400 via-pink-400 to-rose-400 bg-clip-text text-transparent'>
                <span className='hidden sm:inline'>FinSight</span>
                <span className='sm:hidden'>FinSight</span>
              </span>
            </Link>
          </div>
          ...
          <div className='hidden md:flex items-center space-x-1'>
            <Link
              href='/'
              className='relative text-gray-700 hover:text-fuchsia-500 px-3 lg:px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/20 group'
            >
          ...
          <div className='flex items-center space-x-1 sm:space-x-2'>
            ...
            <div className='hidden sm:block'>
              <SignedOut>
                <SignInButton>
                  <button className='relative overflow-hidden bg-gradient-to-r from-fuchsia-400 via-pink-400 to-rose-400 hover:from-fuchsia-500 hover:via-pink-500 hover:to-rose-500 text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95'>
          ...
          <div className='px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg'>
            ...
            <div className='pt-3 border-t border-gray-600/50'>
              <SignedOut>
                <SignInButton>
                  <button
                    className='w-full bg-gradient-to-r from-fuchsia-400 via-pink-400 to-rose-400 hover:from-fuchsia-500 hover:via-pink-500 hover:to-rose-500 text-white px-4 py-3 rounded-xl text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 active:scale-95'
                    onClick={closeMobileMenu}
                  >
                    <span>Sign In</span>
                    <svg
